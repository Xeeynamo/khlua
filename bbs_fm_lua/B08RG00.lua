...
setmetatable({
  ...
  states = {
    ...
    Transform_Idling = {
      OnBeginState = function(_ARG_0_)
        print("b08rg00:Transform_Idling\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 0
      end,
      OnEndState = function(_ARG_0_)
    ...
    Transform_Out = {
      ...
      OnUpdate = function(_ARG_0_)
        ...
        if _ARG_0_.step == TRINITY_TRANSFORM_OUT then
          ...
          _ARG_0_.step = TRINITY_TRANSFORM_CHANGE
        elseif _ARG_0_.step == TRINITY_TRANSFORM_CHANGE and Entity.IsMotionEnd(_ARG_0_.myHandle) then
          EntityManager:GetEntity(B05RG_HANDLE_NOMAL_FOOT):GotoState("Transform_Out")
    ...
    Transform_Out_Idling = {
      OnBeginState = function(_ARG_0_)
        print("b08rg00:Transform_Out_Idling\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 0
      end,
      OnEndState = function(_ARG_0_)
    ...
    Standby = {
      OnBeginState = function(_ARG_0_)
        print("b08rg00:Standby\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 1
        if Entity.GetName(_ARG_0_.myHandle) == "b78vs00" and Mission.IsFlagFinalRound() == 1 then
          _ARG_0_.step = 0
    ...
    Dead = {
      OnBeginState = function(_ARG_0_)
        ...
        B08RG_HANDLE_ROBOT_RIGHTARM = NULL_HANDLE
        if Entity.IsAlive(B05RG_HANDLE_NOMAL_FOOT) and _ARG_0_:GetState() ~= "Dead" then
          EntityManager:GetEntity(B05RG_HANDLE_NOMAL_FOOT):GotoState("Dead")
        end
      end,
      OnEndState = function(_ARG_0_)
        Entity.ClearSpeed(_ARG_0_.myHandle)
  ...
  OnInit = function(_ARG_0_, _ARG_1_)
    print("b08rg00:: OnInit\n")
    _ARG_0_.myHandle = _ARG_1_
    B08RG_HANDLE_ROBOT_FOOT = _ARG_1_
    _ARG_0_.step = 0
    _ARG_0_.targetHandle = NULL_HANDLE
    _ARG_0_.isDead = 0
    _ARG_0_.WorkTime = 0
    if B08RG_INIT_PARAM == false then
      B08RG_INIT_PARAM = true
    end
  ...
  changeLockon = function(_ARG_0_)
    Entity.GetWorldPos(WorkVec, _ARG_0_.myHandle, _UPVALUE0_)
    Entity.GetWorldPos(WorkVec1, _ARG_0_.myHandle, _UPVALUE1_)
    if Entity.CalcDistanceSq(Player.GetHandle(), WorkVec) < Entity.CalcDistanceSq(Player.GetHandle(), WorkVec1) then
  ...
  OnDamage = function(_ARG_0_, _ARG_1_)
    print("b08rg00: OnDamage\n")
    Enemy.SetHP(B05RG_HANDLE_NOMAL_FOOT, (Enemy.GetHp(_ARG_0_.myHandle)))
    return 1
  end,
...
EntityFactory:Add("b08rg00", function(_ARG_0_)
  return (_UPVALUE0_:new())
end)
EntityFactory:Add("b78vs00", function(_ARG_0_)
  return (_UPVALUE0_:new())
end)
