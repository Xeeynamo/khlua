g36ls00 = {}
g36ls00_mt = {__index = g36ls00}
function g36ls00.new(_ARG_0_)
  return setmetatable({}, g36ls00_mt)
end
function g36ls00.OnInit(_ARG_0_, _ARG_1_)
  ...
  Entity.EnableRideColl(_ARG_1_, 1, 0)
  ...
  Entity.SetDropShadowDistance(_ARG_0_.myHandle, 48400)
  Entity.FixDropShadowBgPos(_ARG_0_.myHandle, false)
  Entity.SetDispOffCameraDistance(_ARG_0_.myHandle, -1)
end
function g36ls00.OnUpdate(_ARG_0_)
  Entity.GetWorldPos(_ARG_0_.FloPos, _ARG_0_.myHandle)
  Entity.SetDropShadowDensity(_ARG_0_.myHandle, 1 - 0.033333335 * _ARG_0_.FloPos:gety())
...
EntityFactory:Add("g36ls00", function(_ARG_0_)
  return (g36ls00:new())
end)
