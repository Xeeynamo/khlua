g19ls00 = {}
g19ls00_mt = {__index = g19ls00}
function g19ls00.new(_ARG_0_)
  return setmetatable({}, g19ls00_mt)
end
function g19ls00.OnInit(_ARG_0_, _ARG_1_)
...
function g19ls00.OnUpdate(_ARG_0_)
  Entity.GetWorldPos(_ARG_0_.FloPos, _ARG_0_.myHandle)
...
EntityFactory:Add("g19ls00", function(_ARG_0_)
  return (g19ls00:new())
end)
