g32ls00 = {}
g32ls00_mt = {__index = g32ls00}
function g32ls00.new(_ARG_0_)
  return setmetatable({}, g32ls00_mt)
end
function g32ls00.OnInit(_ARG_0_, _ARG_1_)
...
function g32ls00.OnCommand(_ARG_0_, _ARG_1_)
  Exusia.LoadEvent("gmSelect.exa")
end
function g32ls00.OnUpdate(_ARG_0_)
...
EntityFactory:Add("g32ls00", function(_ARG_0_)
  return (g32ls00:new())
end)
