g11sb00 = {}
g11sb00_mt = {__index = g11sb00}
function g11sb00.new(_ARG_0_)
  return setmetatable({}, g11sb00_mt)
end
function g11sb00.OnInit(_ARG_0_, _ARG_1_)
...
EntityFactory:Add("g11sb00", function(_ARG_0_)
  EntityManager:Add(g11sb00:new(), _ARG_0_)
  return (g11sb00:new())
end)
