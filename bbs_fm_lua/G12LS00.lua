g12ls00 = {}
g12ls00_mt = {__index = g12ls00}
function g12ls00.new(_ARG_0_)
  return setmetatable({}, g12ls00_mt)
end
...
function g12ls00.OnInit(_ARG_0_, _ARG_1_)
...
function g12ls00.CanMainSkip(_ARG_0_)
  ...
  if Entity.GetGravityCoefficient(_ARG_0_.myHandle) >= 1 then
    if _ARG_0_.GravityFlag == 0 then
      ...
      if _ARG_0_.FloPos:gety() < _ARG_0_.StartCenterPos:gety() + 8 then
    ...
    if 0 < _ARG_0_.speed and Entity.IsWall(_ARG_0_.myHandle) then
      ...
      if _ARG_0_.effectFlag == 0 then
        _ARG_0_:createEffect("g_ls_bmbe_0", "G_LS_BMB_CRS0_0")
...
function g12ls00.HitBack(_ARG_0_)
  _ARG_0_.speed = 0.5
  _ARG_0_.gravity = 0.3
...
function g12ls00.OnDamage(_ARG_0_, _ARG_1_)
...
function g12ls00.createEffect(_ARG_0_, _ARG_1_, _ARG_2_)
...
function g12ls00.onHitBody(_ARG_0_)
...
function g12ls00.OnDead(_ARG_0_)
  Gimmick.Delete(_ARG_0_.myHandle)
  _ARG_0_:createEffect("g_ls_bmbe_0", "G_LS_BMB_CRS0_0")
end
function g12ls00.OnDamageBefore(_ARG_0_)
  return 1
end
function g12ls00.OnDamageBefore(_ARG_0_, _ARG_1_)
  return 1
end
EntityFactory:Add("g12ls00", function(_ARG_0_)
  return (g12ls00:new())
end)
