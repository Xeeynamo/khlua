g11ls00 = {}
g11ls00_mt = {__index = g11ls00}
function g11ls00.new(_ARG_0_)
  return setmetatable({}, g11ls00_mt)
end
...
function g11ls00.OnInit(_ARG_0_, _ARG_1_)
...
function g11ls00.createEffect(_ARG_0_, _ARG_1_, _ARG_2_)
...
function g11ls00.CanMainSkip(_ARG_0_)
  ...
  if Entity.GetGravityCoefficient(_ARG_0_.myHandle) >= 1 then
    ...
    if 0 < _ARG_0_.speed and Entity.IsWall(_ARG_0_.myHandle) then
      ...
      if _ARG_0_.effectFlag == 0 then
        _ARG_0_:createEffect("g_ls_cntb_0", "G_LS_CNT_CRS1_0")
...
function g11ls00.HitBack(_ARG_0_)
  _ARG_0_.speed = 0.5
  _ARG_0_.gravity = 0.3
...
function g11ls00.OnDamage(_ARG_0_, _ARG_1_)
...
function g11ls00.onHitBody(_ARG_0_)
...
function g11ls00.OnDead(_ARG_0_)
end
function g11ls00.OnDamageBefore(_ARG_0_)
  return 1
end
function g11ls00.OnDamageBefore(_ARG_0_, _ARG_1_)
  return 1
end
EntityFactory:Add("g11ls00", function(_ARG_0_)
  return (g11ls00:new())
end)
