...
setmetatable({
  ...
  states = {
    ...
    Transform_Idling = {
      OnBeginState = function(_ARG_0_)
        print("b07rg00:Transform_Idling\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 0
      end,
      OnEndState = function(_ARG_0_)
    ...
    Transform_Out_Idling = {
      OnBeginState = function(_ARG_0_)
        print("b07rg00:Transform_Out_Idling\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 0
      end,
      OnEndState = function(_ARG_0_)
    ...
    Standby = {
      OnBeginState = function(_ARG_0_)
        print("b07rg00:Standby\n")
        _ARG_0_:SetMotion(_UPVALUE0_)
        _ARG_0_.step = 1
        if Entity.GetName(_ARG_0_.myHandle) == "b77vs00" and Mission.IsFlagFinalRound() == 1 then
          _ARG_0_.step = 0
    ...
    Dead = {
      OnBeginState = function(_ARG_0_)
        ...
        if Entity.IsAlive(B06RG_HANDLE_ROBOT_RIGHTARM) and _ARG_0_:GetState() ~= "Dead" then
          EntityManager:GetEntity(B06RG_HANDLE_ROBOT_RIGHTARM):GotoState("Dead")
        end
  ...
  OnInit = function(_ARG_0_, _ARG_1_)
    print("b07rg00:: OnInit\n")
    _ARG_0_.myHandle = _ARG_1_
    B07RG_HANDLE_ROBOT_LEFTARM = _ARG_1_
    _ARG_0_.step = 0
    _ARG_0_.targetHandle = NULL_HANDLE
    _ARG_0_.isDead = 0
    _ARG_0_.WorkTime = 0
    if B07RG_INIT_PARAM == false then
      B07RG_INIT_PARAM = true
    end
...
EntityFactory:Add("b07rg00", function(_ARG_0_)
  return (_UPVALUE0_:new())
end)
EntityFactory:Add("b77vs00", function(_ARG_0_)
  return (_UPVALUE0_:new())
end)
