b02cd00 = {}
b02cd00_base_mt = {__index = __StateMachine}
setmetatable(b02cd00, b02cd00_base_mt)
b02cd00_mt = {__index = b02cd00}
function b02cd00.new(_ARG_0_)
  return setmetatable(__StateMachine:new(), b02cd00_mt)
end
b02cd00.states = {
  Appear = {
  ...
  Attack = {
    OnBeginState = function(_ARG_0_)
      ...
      _ARG_0_.workVec0:sety(_ARG_0_.workVec0:gety() + 1.5)
      _ARG_0_.step = 0
    ...
    OnUpdate = function(_ARG_0_)
      if _ARG_0_.step == 0 then
        ...
        if _ARG_0_.workVec0:gety() >= _ARG_0_.workVec1:gety() then
          Entity.ClearSpeed(_ARG_0_.myHandle)
          _ARG_0_.step = 1
        end
      elseif _ARG_0_.step == 1 then
        Entity.TurnTargetYDegree(_ARG_0_.myHandle, _ARG_0_.targetHandle, 10)
        _ARG_0_.velocity:set(0, 0, SymphonyMaster.TRUMPET_SPEED)
...
function b02cd00.TurnX(_ARG_0_, _ARG_1_, _ARG_2_)
  Entity.GetRot(_ARG_0_.rot, _ARG_0_.myHandle)
...
function b02cd00.OnInit(_ARG_0_, _ARG_1_)
  ...
  _ARG_0_.angle = RoundPI(DegToRad(60))
...
function b02cd00.OnDamage(_ARG_0_, _ARG_1_, _ARG_2_)
  return 0
end
function b02cd00.OnReturnDamage(_ARG_0_)
  _ARG_0_:GotoState("Return")
end
function b02cd00.OnMessage(_ARG_0_, _ARG_1_)
...
function b02cd00.OnUpdate(_ARG_0_)
  _ARG_0_:Update()
end
EntityFactory:Add("b02cd00", function(_ARG_0_)
  return (b02cd00:new())
end)
